...
namespace Ifs.Application.Enterp
{
	...
	public partial class cCheckVatService : System.Web.Services.Protocols.SoapHttpClientProtocol {
		...
		/// <remarks/>
		public virtual void checkVatAsync(string countryCode, string vatNumber) {
			this.checkVatAsync(countryCode, vatNumber, null);
		}
		
		/// <remarks/>
		public virtual void checkVatAsync(string countryCode, string vatNumber, object userState) {
		...
		/// <remarks/>
		public virtual void checkVatApproxAsync(string countryCode, string vatNumber, string traderName, string traderCompanyType, string traderStreet, string traderPostcode, string traderCity, string requesterCountryCode, string requesterVatNumber) {
		...
		/// <remarks/>
		public virtual void checkVatApproxAsync(string countryCode, string vatNumber, string traderName, string traderCompanyType, string traderStreet, string traderPostcode, string traderCity, string requesterCountryCode, string requesterVatNumber, object userState) {
