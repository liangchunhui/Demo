...
//  131121  PRatlk  PBFI-2522 , ChildTable Refactoring in ENTERP.
#endregion
...
namespace Ifs.Application.Enterp
{
	...
	/// <summary>
	/// </summary>
	public partial class frmCompanyCommMethod : cFormWindow
	{
		...
		/// <returns></returns>
		public new static frmCompanyCommMethod FromHandle(SalWindowHandle handle)
		{
			return ((frmCompanyCommMethod)SalWindow.FromHandle(handle, typeof(frmCompanyCommMethod)));
		}
		#endregion
		...
		private void tblCommMethod_OnPM_DataRecordNew(object sender, WindowActionsEventArgs e)
		{
            ...
            if (Sal.SendClassMessage(Ifs.Fnd.ApplicationForms.Const.PM_DataRecordNew, Sys.wParam, Sys.lParam)) 
            {
                if (Sys.wParam == Ifs.Fnd.ApplicationForms.Const.METHOD_Execute) 
                {
					...
					this.tblCommMethod.colsIdentity.Text = frmCompany.FromHandle(Ifs.Fnd.ApplicationForms.Int.GetParent(Ifs.Fnd.ApplicationForms.Int.GetParent(this.tblCommMethod.i_hWndSelf))).cmbIdentity.i_sMyValue;
        ...
        #region ChildTable - tblCommMethod
            ...
            public virtual SalBoolean tblCommMethod_DataRecordExecuteNew(SalSqlHandle hSql)
            {
                ...
                using (new SalContext(this))
                {
                    ...
                    tblCommMethod.colsIdentity.Text = frmCompany.FromHandle(Ifs.Fnd.ApplicationForms.Int.GetParent(i_hWndSelf)).cmbIdentity.i_sMyValue;
