...
//  131121  Pratlk  PBFI-2540 , ChildTable refactoring in ENTERP.
#endregion
...
namespace Ifs.Application.Enterp
{
	...
	/// <summary>
	/// </summary>
	public partial class frmOwnerInfoCommMethod : cFormWindow
	{
		...
		/// <returns></returns>
		public new static frmOwnerInfoCommMethod FromHandle(SalWindowHandle handle)
		{
			return ((frmOwnerInfoCommMethod)SalWindow.FromHandle(handle, typeof(frmOwnerInfoCommMethod)));
		}
		#endregion
		...
		private void tblCommMethod_OnPM_DataRecordNew(object sender, WindowActionsEventArgs e)
		{
            ...
            if (Sal.SendClassMessage(Ifs.Fnd.ApplicationForms.Const.PM_DataRecordNew, Sys.wParam, Sys.lParam)) 
            {
                ...
                {
                    this.tblCommMethod.colsPartyTypeDb.Text = "OWNER";
					this.tblCommMethod.colsIdentity.Text = frmOwnerInfo.FromHandle(Ifs.Fnd.ApplicationForms.Int.GetParent(i_hWndSelf)).cmbOwnerId.i_sMyValue;
        ...
        #region ChildTable - tblCommMethod
            ...
            public virtual SalBoolean tblCommMethod_DataRecordExecuteNew(SalSqlHandle hSql)
            {
                ...
                using (new SalContext(this))
                {
                    ...
                    tblCommMethod.colsIdentity.Text = frmOwnerInfo.FromHandle(Ifs.Fnd.ApplicationForms.Int.GetParent(i_hWndSelf)).cmbOwnerId.i_sMyValue;
