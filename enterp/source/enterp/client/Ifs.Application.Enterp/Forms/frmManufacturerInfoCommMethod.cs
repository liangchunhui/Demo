...
//  131121  PRatlk  PBFI-2536, ChildTable Refactoring in ENTERP.
#endregion
...
namespace Ifs.Application.Enterp
{
	...
	/// <summary>
	/// </summary>
	public partial class frmManufacturerInfoCommMethod : cFormWindow
	{
		...
		/// Default Constructor.
		/// </summary>
		public frmManufacturerInfoCommMethod()
		{
		...
		/// <returns></returns>
		public new static frmManufacturerInfoCommMethod FromHandle(SalWindowHandle handle)
		{
			return ((frmManufacturerInfoCommMethod)SalWindow.FromHandle(handle, typeof(frmManufacturerInfoCommMethod)));
		}
		#endregion
		...
		private void tblCommMethod_OnPM_DataRecordNew(object sender, WindowActionsEventArgs e)
		{
            ...
            if (Sal.SendClassMessage(Ifs.Fnd.ApplicationForms.Const.PM_DataRecordNew, Sys.wParam, Sys.lParam)) 
            {
                ...
                {
                    this.tblCommMethod.colsPartyTypeDb.Text = "MANUFACTURER";
					this.tblCommMethod.colsIdentity.Text = frmManufacturerInfo.FromHandle(Ifs.Fnd.ApplicationForms.Int.GetParent(i_hWndSelf)).cmbManufacturerId.i_sMyValue;
        ...
        #region ChildTable - tblCommMethod
            ...
            public virtual SalBoolean tblCommMethod_DataRecordExecuteNew(SalSqlHandle hSql)
            {
                ...
                using (new SalContext(this))
                {
                    ...
                    tblCommMethod.colsIdentity.Text = frmManufacturerInfo.FromHandle(Ifs.Fnd.ApplicationForms.Int.GetParent(i_hWndSelf)).cmbManufacturerId.i_sMyValue;
