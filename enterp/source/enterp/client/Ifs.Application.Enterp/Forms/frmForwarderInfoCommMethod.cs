...
//  131121  PRatlk  PBFI-2532, ChildTable Refactoring in ENTERP.
#endregion
...
namespace Ifs.Application.Enterp
{
	...
	/// <summary>
	/// </summary>
	public partial class frmForwarderInfoCommMethod : cFormWindow
	{
		...
		/// Default Constructor.
		/// </summary>
		public frmForwarderInfoCommMethod()
		{
		...
		/// <returns></returns>
		public new static frmForwarderInfoCommMethod FromHandle(SalWindowHandle handle)
		{
			return ((frmForwarderInfoCommMethod)SalWindow.FromHandle(handle, typeof(frmForwarderInfoCommMethod)));
		}
		#endregion
		...
		private void tblCommMethod_OnPM_DataRecordNew(object sender, WindowActionsEventArgs e)
		{
            ...
            if (Sal.SendClassMessage(Ifs.Fnd.ApplicationForms.Const.PM_DataRecordNew, Sys.wParam, Sys.lParam)) 
            {
                ...
                {
                    this.tblCommMethod.colsPartyTypeDb.Text = "FORWARDER";
					this.tblCommMethod.colsIdentity.Text = frmForwarderInfo.FromHandle(Ifs.Fnd.ApplicationForms.Int.GetParent(i_hWndSelf)).cmbForwarderId.i_sMyValue;
        ...
        #region ChildTable - tblCommMethod
            ...
            public virtual SalBoolean tblCommMethod_DataRecordExecuteNew(SalSqlHandle hSql)
            {
                ...
                using (new SalContext(this))
                {
                    ...
                    tblCommMethod.colsIdentity.Text = frmForwarderInfo.FromHandle(Ifs.Fnd.ApplicationForms.Int.GetParent(i_hWndSelf)).cmbForwarderId.i_sMyValue;
