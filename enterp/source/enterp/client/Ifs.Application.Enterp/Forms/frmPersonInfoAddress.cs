...
#endregion
#region History
// 090902	Hiwilk	Bug 82001, Modified frmPersonInfoAddress().
...
// 131127   PRatlk  PBFI-2543, Client refactoring in ENTERP.
// 140401   Kagalk  PBFI-4142, Merged Bug 113712, Modified to give a warning when deleting the last address type.
// 140715   Maabse  PRSC-1786, Added code if parent is frmCustomerInfoCrmContact.
// 140818   Kagalk  Bug 118344, Added check if Person has been created in Method_Inquire for DataRecordNew
// 150617   SudJlk  ORA-763, Modified SetCountry, frmPersonInfoAddress_OnPM_DataRecordNew and frmPersonInfoAddress_OnPM_DataRecordDuplicate
// 150617           to check if parent is frmSupplierInfoSrmContact.
...
namespace Ifs.Application.Enterp
{
	...
	/// <summary>
	/// </summary>
    public partial class frmPersonInfoAddress : cMasterDetailTabFormWindow
    {
        ...
        public SalString sStreet = "";
        public SalString sHouseNo = "";
        public SalString sFlatNo = "";
        public SalString sNewAddress1 = "";
        ...
        /// <returns></returns>
        public new static frmPersonInfoAddress FromHandle(SalWindowHandle handle)
        {
            return ((frmPersonInfoAddress)SalWindow.FromHandle(handle, typeof(frmPersonInfoAddress)));
        }
        #endregion
        ...
        public virtual SalNumber NewAddressTypes()
        {
            ...
            {
                lsStmt = "&AO.Address_Type_Code_API.Enumerate_Type( :i_hWndFrame.frmPersonInfoAddress.__sAddrTypes, 'PERSON' )";
        ...
        public virtual SalString DefaultExist()
        {
            ...
            namedBindVariables.Add("PersonId", tblAddressType_colsPersonId.QualifiedBindName);
            ...
            DbPLSQLBlock(" {Result} := &AO.Person_Info_Address_Type_API.Default_Exist ( {PersonId} IN , {AddressId} IN , {AddressTypeCode} IN); ", namedBindVariables);
            return sResult;
            #endregion
        }
            ...
            using (new SalContext(this))
            {
                if (Ifs.Fnd.ApplicationForms.Var.Security.IsMethodAvailable("Enterp_Address_Country_API.Set_Lov_Reverence_All"))
                {
                    if (!(bPopulate))
                    {
                        ...
                        using (SignatureHints hints = SignatureHints.NewContext())
                        {
                            hints.Add("Enterp_Address_Country_API.Set_Lov_Reverence_All",
                                System.Data.ParameterDirection.Input,
                                System.Data.ParameterDirection.InputOutput,
                                System.Data.ParameterDirection.InputOutput,
                                System.Data.ParameterDirection.InputOutput);
                            DbPLSQLBlock(cSessionManager.c_hSql, "BEGIN " + lsLovReferenceDbStmt + " END;");
                        }
                    }
        ...
        public virtual SalNumber UM_DetailedAddress(SalNumber nWhat)
        {
            ...
            using (new SalContext(this))
            {
                ...
                {
                    if ((cmbAddressId.i_sMyValue == SalString.Null) || (dfsPersonId.Text == Sys.STRING_Null))
                    {
                        return false;
                    }
                    if (!(Ifs.Fnd.ApplicationForms.Var.Security.IsDataSourceAvailable(Pal.GetActiveInstanceName("dlgDetailedPersonAddress"))))
                    {
                        return false;
                    }
            ...
            using (new SalContext(this))
            {
                if (Ifs.Fnd.ApplicationForms.Var.Security.IsDataSourceAvailable(Pal.GetActiveInstanceName("dlgDetailedPersonAddress")))
                {
                    if (sDetailAddress == "TRUE")
                    {
                        ...
                        dlgDetailedPersonAddress.ModalDialog(i_hWndFrame);
            ...
            using (new SalContext(this))
            {
                ...
                if (Ifs.Fnd.ApplicationForms.Var.Security.IsMethodAvailable("Enterp_Address_Country_API.Get_Detailed_Address"))
                {
                    using (SignatureHints hints = SignatureHints.NewContext())
                    {
                        ...
                        DbPLSQLBlock(cSessionManager.c_hSql, ":i_hWndFrame.frmPersonInfoAddress.sDetailAddress := \r\n" +
                            "                                               		&AO.Enterp_Address_Country_API.Get_Detailed_Address(\r\n" +
                            "                                               		&AO.ISO_Country_Api.Encode(\r\n" +
                            "				:i_hWndFrame.frmPersonInfoAddress.cmbCountry ))");
                    }
                }
            }
        ...
        /// </summary>
        /// <returns></returns>
        public virtual SalNumber CheckAddress1()
        {
            #region Actions
            using (new SalContext(this))
            {
                using (SignatureHints hints = SignatureHints.NewContext())
                {
                    hints.Add("Person_Info_Address_API.Get_Street", System.Data.ParameterDirection.Input, System.Data.ParameterDirection.Input);
                    hints.Add("Person_Info_Address_API.Get_House_No", System.Data.ParameterDirection.Input, System.Data.ParameterDirection.Input);
                    hints.Add("Person_Info_Address_API.Get_Flat_No", System.Data.ParameterDirection.Input, System.Data.ParameterDirection.Input);
                    DbPLSQLBlock(cSessionManager.c_hSql, "BEGIN\r\n" +
                        " :i_hWndFrame.frmPersonInfoAddress.sStreet := &AO.Person_Info_Address_API.Get_Street(:i_hWndFrame.frmPersonInfoAddress.dfsPersonId,\r\n" +
                        "								                 :i_hWndFrame.frmPersonInfoAddress.cmbAddressId.i_sMyValue);\r\n" +
                        " :i_hWndFrame.frmPersonInfoAddress.sHouseNo := &AO.Person_Info_Address_API.Get_House_No(:i_hWndFrame.frmPersonInfoAddress.dfsPersonId,\r\n" +
                        "									:i_hWndFrame.frmPersonInfoAddress.cmbAddressId.i_sMyValue);\r\n" +
                        " :i_hWndFrame.frmPersonInfoAddress.sFlatNo := &AO.Person_Info_Address_API.Get_Flat_No(:i_hWndFrame.frmPersonInfoAddress.dfsPersonId,\r\n" +
                        "									:i_hWndFrame.frmPersonInfoAddress.cmbAddressId.i_sMyValue);\r\n END;");
                }
                if (sFlatNo != SalString.Null)
                {
                    sNewAddress1 = sStreet + " " + sHouseNo + " / " + sFlatNo;
                }
                else
                {
                    sNewAddress1 = sStreet + " " + sHouseNo;
                }
                if (dfsAddress1.Text != sNewAddress1)
                {
                    Ifs.Fnd.ApplicationForms.Int.AlertBox(Properties.Resources.TEXT_DiffAddrress1, Ifs.Fnd.ApplicationForms.Properties.Resources.CAPTION_Information, Ifs.Fnd.ApplicationForms.Const.INFO_Ok);
                }
            }
        ...
        public virtual SalNumber SetCountry()
        {
            ...
            using (new SalContext(this))
            {
                sCountry = frmPersonInfoAddress.FromHandle(i_hWndFrame).cmbCountry.Text;
                if (sCountry == Ifs.Fnd.ApplicationForms.Const.strNULL)
                {
                    if (Ifs.Fnd.ApplicationForms.Int.QualifiedItemNameGet(i_hWndParent) == Pal.GetActiveInstanceName("frmCustomerInfoCrmContact"))
                    {
                        frmPersonInfoAddress.FromHandle(i_hWndFrame).cmbCountry.Text = SalString.FromHandle(SendMessageToParent(Ifs.Application.Enterp.Const.PAM_GetDefaultCountry, 0, 0));
                        sCountry = frmPersonInfoAddress.FromHandle(i_hWndFrame).cmbCountry.Text;
                    }
                    else if (Ifs.Fnd.ApplicationForms.Int.QualifiedItemNameGet(i_hWndParent) == Pal.GetActiveInstanceName("frmSupplierInfoSrmContact"))
                    {
                        frmPersonInfoAddress.FromHandle(i_hWndFrame).cmbCountry.Text = SalString.FromHandle(SendMessageToParent(Ifs.Application.Enterp.Const.PAM_GetDefaultCountry, 0, 0));
                        sCountry = frmPersonInfoAddress.FromHandle(i_hWndFrame).cmbCountry.Text;
                    }
                    ...
                    {
                        frmPersonInfoAddress.FromHandle(i_hWndFrame).cmbCountry.Text = frmPersonInfo.FromHandle(i_hWndParent).cmbCountry.Text;
                        sCountry = frmPersonInfo.FromHandle(i_hWndParent).cmbCountry.Text;
                    }
                }
            }
        ...
        public new SalBoolean FrameStartupUser()
        {
            ...
            using (new SalContext(this))
            {
                lsAddressLayoutsDbStmt = "&AO.ADDRESS_PRESENTATION_API.Get_All_Layouts(:i_hWndFrame.frmPersonInfoAddress.sCountry,\r\n" +
                "						:i_hWndFrame.frmPersonInfoAddress.lsDisplayLayout,\r\n" +
                "						:i_hWndFrame.frmPersonInfoAddress.lsEditLayout, \r\n" +
                "						:i_hWndFrame.frmPersonInfoAddress.sCountryCode )";
                lsLovReferenceDbStmt = "&AO.Enterp_Address_Country_API.Set_Lov_Reverence_All(:i_hWndFrame.frmPersonInfoAddress.sCountryCode,\r\n" +
                "							:i_hWndFrame.frmPersonInfoAddress.sStateLov,\r\n" +
                "							:i_hWndFrame.frmPersonInfoAddress.sCountyLov, \r\n" +
                "							:i_hWndFrame.frmPersonInfoAddress.sCityLov, \r\n" +
                "							:i_hWndFrame.frmPersonInfoAddress.sZipLov );\r\n" +
                "			     :i_hWndFrame.frmPersonInfoAddress.sDetailAddress := &AO.Enterp_Address_Country_API.Get_Detailed_Address(\r\n" +
                "                                               				                &AO.ISO_Country_Api.Encode(\r\n" +
                "							:i_hWndFrame.frmPersonInfoAddress.cmbCountry.i_sMyValue ));";
        ...
        public virtual SalNumber InitValuesForPopulate()
        {
            ...
            {
                lsStmt = "DECLARE\r\n" +
                "		country_code_	VARCHAR2(10);\r\n	BEGIN " + Vis.StrSubstitute(lsAddressLayoutsDbStmt, ":i_hWndFrame.frmPersonInfoAddress.sCountryCode", "country_code_") + ";  " + Vis.StrSubstitute(lsLovReferenceDbStmt, ":i_hWndFrame.frmPersonInfoAddress.sCountryCode",
                    "country_code_") + " " + ":i_hWndFrame.frmPersonInfoAddress.sCountryCode := country_code_;\r\n	END;";
                DbPLSQLBlock(cSessionManager.c_hSql, lsStmt);
            }
        ...
        private void frmPersonInfoAddress_WindowActions(object sender, WindowActionsEventArgs e)
        {
            #region Actions
            switch (e.ActionType)
            {
                case Ifs.Fnd.ApplicationForms.Const.PM_DataRecordNew:
                    this.frmPersonInfoAddress_OnPM_DataRecordNew(sender, e);
                    break;

                case Ifs.Fnd.ApplicationForms.Const.PM_DataRecordDuplicate:
                    this.frmPersonInfoAddress_OnPM_DataRecordDuplicate(sender, e);
                    break;

                case Const.PAM_DetailAddress:
                    this.frmPersonInfoAddress_OnPAM_DetailAddress(sender, e);
                    break;


                case Ifs.Fnd.ApplicationForms.Const.PM_DataRecordRemove:
                    this.frmPersonInfoAddress_OnPM_DataRecordRemove(sender, e);
                    break;

                case Ifs.Fnd.ApplicationForms.Const.PM_DataRecordPaste:
                    this.frmPersonInfoAddress_OnPM_DataRecordPaste(sender, e);
                    break;
        ...
        private void frmPersonInfoAddress_OnPM_DataRecordNew(object sender, WindowActionsEventArgs e)
        {
            #region Actions
            e.Handled = true;
            ...
            {                
                ...
                else if (Sys.wParam == Ifs.Fnd.ApplicationForms.Const.METHOD_Execute)                
                {
                    if (Ifs.Fnd.ApplicationForms.Int.QualifiedItemNameGet(i_hWndParent) == Pal.GetActiveInstanceName("frmCustomerInfoCrmContact"))
                    {
                        this.cmbCountry.Text = SalString.FromHandle(SendMessageToParent(Ifs.Application.Enterp.Const.PAM_GetDefaultCountry, 0, 0));
                        this.cmbCountry.EditDataItemSetEdited();
                    }
                    else if (Ifs.Fnd.ApplicationForms.Int.QualifiedItemNameGet(i_hWndParent) == Pal.GetActiveInstanceName("frmSupplierInfoSrmContact"))
                    {
                        this.cmbCountry.Text = SalString.FromHandle(SendMessageToParent(Ifs.Application.Enterp.Const.PAM_GetDefaultCountry, 0, 0));
                    ...
                    {
                        Sal.SendMsg(this.cmbCountry, Ifs.Fnd.ApplicationForms.Const.PM_DataItemValueSet, 1, ((SalString)frmPersonInfo.FromHandle(this.i_hWndParent).cmbCountry.Text).ToHandle());
                    }
        ...
        /// </summary>
        /// <param name="message"></param>
        private void frmPersonInfoAddress_OnPM_DataRecordDuplicate(object sender, WindowActionsEventArgs e)
        {
            #region Actions
            e.Handled = true;
        ...
        /// </summary>
        /// <param name="message"></param>
        private void frmPersonInfoAddress_OnPAM_DetailAddress(object sender, WindowActionsEventArgs e)
        {
            #region Actions
            e.Handled = true;
        ...
        /// </summary>
        /// <param name="message"></param>
        private void frmPersonInfoAddress_OnPM_DataRecordRemove(object sender, WindowActionsEventArgs e)
        {
            #region Actions
            e.Handled = true;
            if (Sys.wParam == Ifs.Fnd.ApplicationForms.Const.METHOD_Execute)
        ...
        /// </summary>
        /// <param name="message"></param>
        private void frmPersonInfoAddress_OnPM_DataRecordPaste(object sender, WindowActionsEventArgs e)
        {
            #region Actions
            e.Handled = true;
        ...
        #region ChildTable - tblAddressType
            ...
            public SalString tblAddressType_sTempPersonId = "";
            #endregion
            ...
            public virtual SalBoolean tblAddressType_CheckDefaultAddress()
            {
                ...
                using (new SalContext(tblAddressType))
                {
                    ...
                    tblAddressType_sTempPersonId = SalString.Null;
                    ...
                    while (true)
                    {
                        if (Sal.TblFindNextRow(tblAddressType, ref nCurrentRow, 0, 0))
                        {
                            ...
                            lsStmt = lsStmt + "&AO.PERSON_INFO_ADDRESS_TYPE_API.Check_Def_Address_Exist (\r\n" +
                                                                                                        ":i_hWndFrame.frmPersonInfoAddress.tblAddressType_sTempAddressValidation[" + nIndex.ToString(0) + "] OUT,\r\n" +
                                                                                                        ":i_hWndFrame.frmPersonInfoAddress.tblAddressType_sValidFlag[" + nIndex.ToString(0) + "] OUT ,\r\n" +
                                                                                                        ":i_hWndFrame.frmPersonInfoAddress.tblAddressType_sTempPersonId IN ,\r\n" +
                                                                                                        ":i_hWndFrame.frmPersonInfoAddress.tblAddressType_sDefAddress[" + nIndex.ToString(0) + "] IN ,\r\n" +
                                                                                                        ":i_hWndFrame.frmPersonInfoAddress.tblAddressType_sAddressTypeCodeArr[" + nIndex.ToString(0) + "] IN ,\r\n" +
                                                                                                        ":i_hWndFrame.frmPersonInfoAddress.tblAddressType_sObjId[" + nIndex.ToString(0) + "] IN ,\r\n" +
                                                                                                        ":i_hWndFrame.frmPersonInfoAddress.tblAddressType_dTempFromDate[" + nIndex.ToString(0) + "] IN ,\r\n" +
                                                                                                        ":i_hWndFrame.frmPersonInfoAddress.tblAddressType_dTempToDate[" + nIndex.ToString(0) + "] IN );";
                            ...
                            tblAddressType_sTempPersonId = this.tblAddressType_colsPersonId.Text;
                    ...
                    sAddressTypeCodeMsg[2] = this.tblAddressType_colsPersonId.Text;
                        ...
                        if (Sal.TblFindNextRow(tblAddressType, ref nCurrentRow, nRowCondition, 0))
                        {
                            ...
                            if (this.tblAddressType_colDefAddress.Text == "TRUE")
                            {
                                lsStmt = lsStmt + "&AO.PERSON_INFO_ADDRESS_TYPE_API.Check_Def_Address_Exist (\r\n" +
                                                                                                            ...
                                                                                                            ":i_hWndFrame.frmPersonInfoAddress.tblAddressType_sAddressTypeCodeArr[" + nIndex.ToString(0) + "] IN ,\r\n" +
                                                                                                            ":i_hWndFrame.frmPersonInfoAddress.tblAddressType_sObjId[" + nIndex.ToString(0) + "] IN ,\r\n" +
                                                                                                            ":i_hWndFrame.frmPersonInfoAddress.tblAddressType_dTempFromDate[" + ((SalNumber)0).ToString(0) + "] IN ,\r\n" +
                                                                                                            ":i_hWndFrame.frmPersonInfoAddress.tblAddressType_dTempToDate[" + ((SalNumber)0).ToString(0) + "] IN );";
                                tblAddressType_sAddressId[nIndex] = this.tblAddressType_colsAddressId.Text;
                                tblAddressType_sAddressTypeCodeArr[nIndex] = this.tblAddressType_colsAddressTypeCode.Text;
                                tblAddressType_sDefAddress[nIndex] = this.tblAddressType_colDefAddress.Text;
                                tblAddressType_sObjId[nIndex] = this.tblAddressType.__colObjid.Text;
            ...
            public virtual SalBoolean tblAddressType_CheckLastAddressType()
            {
                ...
                using (new SalContext(this))
                {
                    ...
                    if (nCountRows == 0)
                    {
                        ...
                        sMessage[2] = this.tblAddressType_colsPersonId.Text;
            ...
            public virtual SalBoolean tblAddressType_RemoveDefaultAddress()
            {
                ...
                using (new SalContext(tblAddressType))
                {
                    ...
                    while (nIndex <= nCount)
                    {
                        ...
                        {
                            lsStmt = lsStmt + "&AO.PERSON_INFO_ADDRESS_TYPE_API.Check_Def_Addr_Temp (:i_hWndFrame.frmPersonInfoAddress.tblAddressType_sTempPersonId IN ,\r\n" +
                                                                                                    ":i_hWndFrame.frmPersonInfoAddress.tblAddressType_sAddressTypeCodeArr[" + nIndex.ToString(0) + "] IN ,\r\n" +
                                                                                                    ":i_hWndFrame.frmPersonInfoAddress.tblAddressType_sDefAddress[" + nIndex.ToString(0) + "] IN ,\r\n" +
                                                                                                    ":i_hWndFrame.frmPersonInfoAddress.tblAddressType_sObjId[" + nIndex.ToString(0) + "] IN ,\r\n" +
                                                                                                    ":i_hWndFrame.frmPersonInfoAddress.tblAddressType_dTempFromDate[" + nIndex.ToString(0) + "] IN ,\r\n" +
            ...
            public virtual SalNumber tblAddressType_DataSourcePrepareKeyTransfer(SalString sWindowName)
            {
                ...
                using (new SalContext(tblAddressType))
                {
                    if (sWindowName == Pal.GetActiveInstanceName("frmHistoryLog"))
                    {
                        ...
                        sItemNames[2] = "PERSON_ID";
                        hWndItems[2] = tblAddressType_colsPersonId;
                    }
                    else
                    {
                        return ((cDataSource)this.tblAddressType).DataSourcePrepareKeyTransfer(sWindowName);
                    }
                    Ifs.Fnd.ApplicationForms.Var.DataTransfer.Init("PersonInfoAddressType", Sys.hWndForm, sItemNames, hWndItems);
            ...
            private void colsAddressTypeCode_WindowActions(object sender, WindowActionsEventArgs e)
            {
                ...
                switch (e.ActionType)
                {
                    case Ifs.Fnd.ApplicationForms.Const.PM_LookupInit:
                        e.Handled = true;
                        this.tblAddressType_colsAddressTypeCode.TypeCodeLookupInit("PERSON");
                        break;
        ...
        #region ChildTable - tblCommMethod
            ...
            public virtual SalBoolean tblCommMethod_DataRecordExecuteNew(SalSqlHandle hSql)
            {
                ...
                using (new SalContext(tblCommMethod))
                {
                    ...
                    tblCommMethod.colsIdentity.Text = SalString.FromHandle(this.dfsPersonId.EditDataItemValueGet());
