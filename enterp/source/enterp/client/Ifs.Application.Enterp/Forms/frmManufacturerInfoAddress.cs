...
#endregion
#region History
// 090902	Hiwilk	Bug 82001, Modified frmManufacturerInfoAddress().
...
// 131128   PRatlk  PBFI-2534,  Client Refactoring in ENTERP.
...
namespace Ifs.Application.Enterp
{
	...
	/// <summary>
	/// </summary>
	public partial class frmManufacturerInfoAddress : cMasterDetailTabFormWindow
	{
		...
		/// Default Constructor.
		/// </summary>
		public frmManufacturerInfoAddress()
		{
		...
		/// <returns></returns>
		public new static frmManufacturerInfoAddress FromHandle(SalWindowHandle handle)
		{
			return ((frmManufacturerInfoAddress)SalWindow.FromHandle(handle, typeof(frmManufacturerInfoAddress)));
		}
		#endregion
		...
		public virtual SalNumber NewAddressTypes()
		{
			...
			{
				lsStmt = "&AO.Address_Type_Code_API.Enumerate_Type( :i_hWndFrame.frmManufacturerInfoAddress.__sAddrTypes, 'MANUFACTURER' )";
        ...
        public virtual SalString DefaultExist()
        {
            ...
            namedBindVariables.Add("ManufacturerId", tblAddressType_colsManufacturerId.QualifiedBindName);
            ...
            DbPLSQLBlock(" {Result} := &AO.Manuf_Info_Addr_Type_API.Default_Exist ( {ManufacturerId} IN , {AddressId} IN , {AddressTypeCode} IN); ", namedBindVariables);
            return sResult;
            #endregion
        }
		/// <summary>
		...
		public virtual SalNumber SetCountry()
		{
			...
			using (new SalContext(this))
			{
				sCountry = frmManufacturerInfoAddress.FromHandle(i_hWndFrame).cmbCountry.Text;
				if (sCountry == Ifs.Fnd.ApplicationForms.Const.strNULL) 
				{
					sCountry = frmManufacturerInfo.FromHandle(i_hWndParent).cmbCountry.Text;
					frmManufacturerInfoAddress.FromHandle(i_hWndFrame).cmbCountry.Text = frmManufacturerInfo.FromHandle(i_hWndParent).cmbCountry.Text;
				}
			}
		...
		public new SalBoolean FrameStartupUser()
		{
			...
			using (new SalContext(this))
			{
				lsAddressLayoutsDbStmt = "&AO.ADDRESS_PRESENTATION_API.Get_All_Layouts(:i_hWndFrame.frmManufacturerInfoAddress.sCountry,\r\n" +
				"						:i_hWndFrame.frmManufacturerInfoAddress.lsDisplayLayout,\r\n" +
				"						:i_hWndFrame.frmManufacturerInfoAddress.lsEditLayout,\r\n" +
				"						:i_hWndFrame.frmManufacturerInfoAddress.sCountryCode )";
				lsLovReferenceDbStmt = "&AO.Enterp_Address_Country_API.Set_Lov_Reverence_All(:i_hWndFrame.frmManufacturerInfoAddress.sCountryCode,\r\n" +
				"							:i_hWndFrame.frmManufacturerInfoAddress.sStateLov,\r\n" +
				"							:i_hWndFrame.frmManufacturerInfoAddress.sCountyLov, \r\n" +
                "							:i_hWndFrame.frmManufacturerInfoAddress.sCityLov, \r\n" +
				"							:i_hWndFrame.frmManufacturerInfoAddress.sZipLov )";
		...
		public virtual SalNumber InitValuesForPopulate()
		{
			...
			{
				lsStmt = "DECLARE\r\n" +
				"		country_code_	VARCHAR2(10);\r\n	BEGIN " + Vis.StrSubstitute(lsAddressLayoutsDbStmt, ":i_hWndFrame.frmManufacturerInfoAddress.sCountryCode", "country_code_") + ";  " + Vis.StrSubstitute(lsLovReferenceDbStmt, ":i_hWndFrame.frmManufacturerInfoAddress.sCountryCode", 
					"country_code_") + "; " + ":i_hWndFrame.frmManufacturerInfoAddress.sCountryCode := country_code_;\r\n	END;";
				DbPLSQLBlock(cSessionManager.c_hSql, lsStmt);
			}
		...
		private void frmManufacturerInfoAddress_WindowActions(object sender, WindowActionsEventArgs e)
		{
			#region Actions
			switch (e.ActionType)
			{
				case Ifs.Fnd.ApplicationForms.Const.PM_DataRecordNew:
					this.frmManufacturerInfoAddress_OnPM_DataRecordNew(sender, e);
					break;
				
				case Ifs.Fnd.ApplicationForms.Const.PM_DataRecordDuplicate:
					this.frmManufacturerInfoAddress_OnPM_DataRecordDuplicate(sender, e);
					break;
				
				
				case Ifs.Fnd.ApplicationForms.Const.PM_DataRecordRemove:
					this.frmManufacturerInfoAddress_OnPM_DataRecordRemove(sender, e);
					break;

                case Ifs.Fnd.ApplicationForms.Const.PM_DataRecordPaste:
                    this.frmManufacturerInfoAddress_OnPM_DataRecordPaste(sender, e);
                    break;
		...
		private void frmManufacturerInfoAddress_OnPM_DataRecordNew(object sender, WindowActionsEventArgs e)
		{
			#region Actions
			e.Handled = true;
			if (Sal.SendClassMessage(Ifs.Fnd.ApplicationForms.Const.PM_DataRecordNew, Sys.wParam, Sys.lParam)) 
			{
				...
				{
					Sal.SendMsg(this.cmbCountry, Ifs.Fnd.ApplicationForms.Const.PM_DataItemValueSet, 1, ((SalString)frmManufacturerInfo.FromHandle(this.i_hWndParent).cmbCountry.Text).ToHandle());
		...
		/// </summary>
		/// <param name="message"></param>
		private void frmManufacturerInfoAddress_OnPM_DataRecordDuplicate(object sender, WindowActionsEventArgs e)
		{
			#region Actions
			e.Handled = true;
		...
		/// </summary>
		/// <param name="message"></param>
		private void frmManufacturerInfoAddress_OnPM_DataRecordRemove(object sender, WindowActionsEventArgs e)
		{
			#region Actions
			e.Handled = true;
			if (Sys.wParam == Ifs.Fnd.ApplicationForms.Const.METHOD_Execute) 
        ...
        /// </summary>
        /// <param name="message"></param>
        private void frmManufacturerInfoAddress_OnPM_DataRecordPaste(object sender, WindowActionsEventArgs e)
        {
            #region Actions
            e.Handled = true;
        ...
        #region ChildTable - tblAddressType
            ...
            public SalString tblAddressType_sTempManufacturerId = "";
            #endregion
            ...
            public virtual SalBoolean tblAddressType_CheckDefaultAddress()
            {
                ...
                using (new SalContext(tblAddressType))
                {
                    ...
                    tblAddressType_sTempManufacturerId = SalString.Null;
                    ...
                    while (true)
                    {
                        if (Sal.TblFindNextRow(tblAddressType, ref nCurrentRow, 0, 0))
                        {
                            ...
                            lsStmt = lsStmt + "&AO.MANUF_INFO_ADDR_TYPE_API.Check_Def_Address_Exist (\r\n" +
                            "                                                                                                                        :i_hWndFrame.frmManufacturerInfoAddress.tblAddressType_sTempAddressValidation[" + nIndex.ToString(0) + "] OUT,\r\n" +
                            "                                                                                                                        :i_hWndFrame.frmManufacturerInfoAddress.tblAddressType_sValidFlag[" + nIndex.ToString(0) + "] OUT ,\r\n" +
                            "                                                                                                                        :i_hWndFrame.frmManufacturerInfoAddress.tblAddressType_sTempManufacturerId IN ,\r\n" +
                            "                                                                                                                        :i_hWndFrame.frmManufacturerInfoAddress.tblAddressType_sDefAddress[" + nIndex.ToString(0) + "] IN ,\r\n" +
                            "                                                                                                                        :i_hWndFrame.frmManufacturerInfoAddress.tblAddressType_sAddressTypeCodeArr[" + nIndex.ToString(0) + "] IN ,\r\n" +
                            "                                                                                                                        :i_hWndFrame.frmManufacturerInfoAddress.tblAddressType_sObjId[" + nIndex.ToString(0) + "] IN ,\r\n" +
                            "                                                                                                                        :i_hWndFrame.frmManufacturerInfoAddress.tblAddressType_dTempFromDate[" + nIndex.ToString(0) + "] IN ,\r\n" +
                            "                                                                                                                        :i_hWndFrame.frmManufacturerInfoAddress.tblAddressType_dTempToDate[" + nIndex.ToString(0) + "] IN );";
                            ...
                            tblAddressType_sTempManufacturerId = this.tblAddressType_colsManufacturerId.Text;
                    ...
                    sAddressTypeCodeMsg[2] = this.tblAddressType_colsManufacturerId.Text;
                    ...
                    while (true)
                    {
                        if (Sal.TblFindNextRow(tblAddressType, ref nCurrentRow, nRowCondition, 0))
                        {
                            ...
                            if (this.tblAddressType_colDefAddress.Text == "TRUE")
                            {
                                ...
                                "                                                                                                                        :i_hWndFrame.frmManufacturerInfoAddress.tblAddressType_sAddressTypeCodeArr[" + nIndex.ToString(0) + "] IN ,\r\n" +
                                "                                                                                                                        :i_hWndFrame.frmManufacturerInfoAddress.tblAddressType_sObjId[" + nIndex.ToString(0) + "] IN,\r\n" +
                                "                                                                                                                        :i_hWndFrame.frmManufacturerInfoAddress.tblAddressType_dTempFromDate[" + ((SalNumber)0).ToString(0) + "] IN,\r\n" +
                                "                                                                                                                        :i_hWndFrame.frmManufacturerInfoAddress.tblAddressType_dTempToDate[" + ((SalNumber)0).ToString(0) + "]  IN );";
                                tblAddressType_sAddressId[nIndex] = this.tblAddressType_colsAddressId.Text;
                                tblAddressType_sAddressTypeCodeArr[nIndex] = this.tblAddressType_colsAddressTypeCode.Text;
                                tblAddressType_sDefAddress[nIndex] = this.tblAddressType_colDefAddress.Text;
                                tblAddressType_sObjId[nIndex] = this.tblAddressType.__colObjid.Text;
            ...
            public virtual SalBoolean tblAddressType_CheckLastAddressType()
            {
                ...
                using (new SalContext(this))
                {
                    ...
                    if (nCountRows == 0)
                    {
                        ...
                        sMessage[2] = this.tblAddressType_colsManufacturerId.Text;
            ...
            public virtual SalBoolean tblAddressType_RemoveDefaultAddress()
            {
                ...
                using (new SalContext(tblAddressType))
                {
                    ...
                    while (nIndex <= nCount)
                    {
                        ...
                        {
                            lsStmt = lsStmt + "&AO.MANUF_INFO_ADDR_TYPE_API.Check_Def_Addr_Temp (:i_hWndFrame.frmManufacturerInfoAddress.tblAddressType_sTempManufacturerId IN ,\r\n" +
                                                                                                ":i_hWndFrame.frmManufacturerInfoAddress.tblAddressType_sAddressTypeCodeArr[" + nIndex.ToString(0) + "] IN ,\r\n" +
                                                                                                ":i_hWndFrame.frmManufacturerInfoAddress.tblAddressType_sDefAddress[" + nIndex.ToString(0) + "] IN ,\r\n" +
                                                                                                ":i_hWndFrame.frmManufacturerInfoAddress.tblAddressType_sObjId[" + nIndex.ToString(0) + "] IN ,\r\n" +
                                                                                                ":i_hWndFrame.frmManufacturerInfoAddress.tblAddressType_dTempFromDate[" + nIndex.ToString(0) + "] IN ,\r\n" +
            ...
            public virtual SalNumber tblAddressType_DataSourcePrepareKeyTransfer(SalString sWindowName)
            {
                ...
                using (new SalContext(tblAddressType))
                {
                    if (sWindowName == Pal.GetActiveInstanceName("frmHistoryLog"))
                    {
                        ...
                        sItemNames[2] = "MANUFACTURER_ID";
                        hWndItems[2] = tblAddressType_colsManufacturerId;
                    }
                    else
                    {
                        return ((cDataSource)this.tblAddressType).DataSourcePrepareKeyTransfer(sWindowName);
                    }
                    Ifs.Fnd.ApplicationForms.Var.DataTransfer.Init("ManufInfoAddrType", Sys.hWndForm, sItemNames, hWndItems);
            ...
            private void colsAddressTypeCode_WindowActions(object sender, WindowActionsEventArgs e)
            {
                ...
                switch (e.ActionType)
                {
                    case Ifs.Fnd.ApplicationForms.Const.PM_LookupInit:
                        e.Handled = true;
                        this.tblAddressType_colsAddressTypeCode.TypeCodeLookupInit("MANUFACTURER");
                        break;
        ...
        #region ChildTable - tblCommMethod
            ...
            public virtual SalBoolean tblCommMethod_DataRecordExecuteNew(SalSqlHandle hSql)
            {
                ...
                {
                    tblCommMethod.colsPartyTypeDb.Text = "MANUFACTURER";
                    tblCommMethod.colsIdentity.Text = SalString.FromHandle(this.dfsManufacturerId.EditDataItemValueGet());
