...
namespace Ifs.Application.Enterp
{
	...
	public partial class frmForwarderInfo
	{
		...
		protected cBackgroundText labelcmbForwarderId;
		public cRecListDataField cmbForwarderId;
		...
		// ! Bug 79336, End
		protected SalGroupBox gbOur_ID_at_Forwarder;
		...
		{
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmForwarderInfo));
            this.labelcmbForwarderId = new Ifs.Fnd.ApplicationForms.cBackgroundText();
            this.cmbForwarderId = new Ifs.Fnd.ApplicationForms.cRecListDataField();
            ...
            this.gbOur_ID_at_Forwarder = new PPJ.Runtime.Windows.SalGroupBox();
            ...
            this.tblOurId_colsForwarderId = new Ifs.Fnd.ApplicationForms.cColumn();
            ...
            // labelcmbForwarderId
            // 
            resources.ApplyResources(this.labelcmbForwarderId, "labelcmbForwarderId");
            this.labelcmbForwarderId.Name = "labelcmbForwarderId";
            // 
            // cmbForwarderId
            // 
            this.cmbForwarderId.CharacterCasing = System.Windows.Forms.CharacterCasing.Upper;
            resources.ApplyResources(this.cmbForwarderId, "cmbForwarderId");
            this.cmbForwarderId.Name = "cmbForwarderId";
            this.cmbForwarderId.NamedProperties.Put("EnumerateMethod", "");
            this.cmbForwarderId.NamedProperties.Put("FieldFlags", "162");
            this.cmbForwarderId.NamedProperties.Put("Format", "9");
            this.cmbForwarderId.NamedProperties.Put("LovReference", "");
            this.cmbForwarderId.NamedProperties.Put("ResizeableChildObject", "");
            this.cmbForwarderId.NamedProperties.Put("SqlColumn", "FORWARDER_ID");
            this.cmbForwarderId.NamedProperties.Put("ValidateMethod", "");
            this.cmbForwarderId.NamedProperties.Put("XDataLength", "20");
            this.cmbForwarderId.WindowActions += new PPJ.Runtime.Windows.WindowActionsEventHandler(this.cmbForwarderId_WindowActions);
            // 
            // labeldfsName
            // 
            ...
            this.dfsName.NamedProperties.Put("ParentName", "cmbForwarderId");
            ...
            this.dfsAssociationNo.NamedProperties.Put("ParentName", "cmbForwarderId");
            ...
            // 
            // gbOur_ID_at_Forwarder
            // 
            this.gbOur_ID_at_Forwarder.BackColor = System.Drawing.Color.Transparent;
            this.picTab.SetControlTabPages(this.gbOur_ID_at_Forwarder, "Name0");
            resources.ApplyResources(this.gbOur_ID_at_Forwarder, "gbOur_ID_at_Forwarder");
            this.gbOur_ID_at_Forwarder.Name = "gbOur_ID_at_Forwarder";
            this.gbOur_ID_at_Forwarder.TabStop = false;
            // 
            // dfsExist
            // 
            ...
            this.tblOurId.Controls.Add(this.tblOurId_colsForwarderId);
            ...
            this.tblOurId.NamedProperties.Put("LogicalUnit", "ForwarderInfoOurId");
            this.tblOurId.NamedProperties.Put("PackageName", "FORWARDER_INFO_OUR_ID_API");
            this.tblOurId.NamedProperties.Put("ResizeableChildObject", "");
            this.tblOurId.NamedProperties.Put("ViewName", "FORWARDER_INFO_OUR_ID_FIN_AUTH");
            this.tblOurId.NamedProperties.Put("Warnings", "FALSE");
            this.tblOurId.Controls.SetChildIndex(this.tblOurId_colsForwarderId, 0);
            ...
            // 
            // tblOurId_colsForwarderId
            // 
            this.tblOurId_colsForwarderId.CharacterCasing = System.Windows.Forms.CharacterCasing.Upper;
            resources.ApplyResources(this.tblOurId_colsForwarderId, "tblOurId_colsForwarderId");
            this.tblOurId_colsForwarderId.MaxLength = 20;
            this.tblOurId_colsForwarderId.Name = "tblOurId_colsForwarderId";
            this.tblOurId_colsForwarderId.NamedProperties.Put("EnumerateMethod", "");
            this.tblOurId_colsForwarderId.NamedProperties.Put("FieldFlags", "67");
            this.tblOurId_colsForwarderId.NamedProperties.Put("LovReference", "FORWARDER_INFO");
            this.tblOurId_colsForwarderId.NamedProperties.Put("SqlColumn", "FORWARDER_ID");
            this.tblOurId_colsForwarderId.Position = 5;
            // 
            // frmForwarderInfo
            // 
            ...
            this.Controls.Add(this.cmbForwarderId);
            ...
            this.Controls.Add(this.labelcmbForwarderId);
            this.Controls.Add(this.gbOur_ID_at_Forwarder);
            this.Name = "frmForwarderInfo";
            this.NamedProperties.Put("DefaultOrderBy", "");
            this.NamedProperties.Put("DefaultWhere", "");
            this.NamedProperties.Put("LogicalUnit", "ForwarderInfo");
            this.NamedProperties.Put("PackageName", "FORWARDER_INFO_API");
            this.NamedProperties.Put("ParentName", "[NaturalParent]");
            this.NamedProperties.Put("ResizeableChildObject", "");
            this.NamedProperties.Put("SourceFlags", "4545");
            this.NamedProperties.Put("ViewName", "FORWARDER_INFO");
            this.NamedProperties.Put("Warnings", "TRUE");
            this.WindowActions += new PPJ.Runtime.Windows.WindowActionsEventHandler(this.frmForwarderInfo_WindowActions);
            this.Controls.SetChildIndex(this.picTab, 0);
            this.Controls.SetChildIndex(this.gbOur_ID_at_Forwarder, 0);
            this.Controls.SetChildIndex(this.labelcmbForwarderId, 0);
            ...
            this.Controls.SetChildIndex(this.cmbForwarderId, 0);
        ...
        protected cColumn tblOurId_colsForwarderId;
